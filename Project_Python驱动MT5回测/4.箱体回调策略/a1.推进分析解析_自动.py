...
ea_inputparalist = ["MaxBoxPeriod", "OsciBoxPeriod", "K_TrendBuyU", "K_TrendBuyD", "TrendGap",
                    "K_OsciBuyLevel", "OsciGap", "CloseBuyLevel"] # 仅优化的参数就可以了.
...
bt_experfolder = "My_Experts\\Strategy深度研究\\4.箱体回调策略\\推进交易.Balance_max.2Y6M"
bt_expertfile = "a1.f4.{}.{}.ex5".format("_Symbol", myMT5run.timeframe_to_ini_affix(timeframe))
# (***)推进回测的时间起始(***)
...
for symbol in symbollist:
    ...
    for sortby, chooseby, resultlist in modecollection:
        ...
        profitinpips = 1 # profitinpips = 1 用pips作为利润，不用具体的货币。0用具体货币，且考虑佣金
