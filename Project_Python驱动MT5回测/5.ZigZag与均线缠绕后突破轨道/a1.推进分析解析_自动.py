...
FwdAuto.expertfile = "a1.一次一单.ex5"
FwdAuto.contentfolder = r"F:\BaiduNetdiskWorkspace\工作---MT5策略研究\8.ZigZag与均线缠绕后突破轨道" # 输出的总目录******
# (***)根据基础EA源码的Input变量的顺序来整理下面参数名(***)
FwdAuto.ea_inputparalist = ["Inp_NExtrama", "Inp_OsciAlpha", "Inp_NCrossLimit", "Inp_NBarCount"]


FwdAuto.symbollist = ["EURUSD", "GBPUSD", "AUDUSD", "NZDUSD", "USDJPY", "USDCAD", "USDCHF", "XAUUSD", "XAGUSD", "AUDJPY","CHFJPY","EURAUD","EURCAD","EURCHF","EURGBP","EURJPY","GBPAUD","GBPCAD","GBPCHF","GBPJPY","NZDJPY"] # 策略的品种列表******
...
FwdAuto.bt_experfolder = "My_Experts\\Strategy深度研究\\5.ZigZag与均线缠绕后突破轨道\\推进交易.2Y6M"
FwdAuto.bt_expertfile = "a1.f5.{}.{}.ex5".format("_Symbol", myMT5run.timeframe_to_ini_affix(FwdAuto.timeframe))
# (***)推进回测的时间起始(***)
