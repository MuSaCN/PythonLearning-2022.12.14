...
FwdOpt.experfolder = "My_Experts\\Strategy深度研究\\3.包络线振荡策略"  # (***)基础EA所在的目录(***)
FwdOpt.expertfile = "a1.包络线振荡策略.ex5"  # (***)基础EA(***)
FwdOpt.contentfolder = r"F:\BaiduNetdiskWorkspace\工作---MT5策略研究\6.包络线振荡策略" # 输出的总目录******
